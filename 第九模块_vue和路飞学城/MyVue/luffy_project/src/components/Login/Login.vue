<template>
  	...
  	<div class="box">
  		<img src="https://ss3.bdstatic.com/lPoZeXSm1A5BphGlnYG/skin/826.jpg?2" alt="">
  		<div class="login">
...
<!--  			</div>-->
  			<div class="login_box">
  				...
  				<div class="inp">
  					...
  					<button class="login_btn" @click="clickHandler">登录</button>
  ...
  export default {
    ...
    data(){
      return{
        username:'',
        password:'',
        validateResult:{}, //验证成功后返回的结果，用于服务端的sdk二次验证
      }
    },
