"""
Django settings for luffty_crm project.
...
SECRET_KEY = 'r!_b5ao6vvxc$_k9+%2@jvs-u@!(#61(9f!1))ps$5-w1-646*'
...
WSGI_APPLICATION = 'luffty_crm.wsgi.application'
