...
if __name__ == '__main__':
    ...
    # 爬取个人主页信息数据
    detail_url = 'http://www.renren.com/973019309/newsfeed/photo'

    # 使用session对象发送get请求
    detail = session.get(url=detail_url, headers=headers).text

    with open('summer.html', 'w', encoding='utf-8') as f:
        f.write(detail)
