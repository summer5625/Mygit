"""
Django settings for use_rbac project.
...
SECRET_KEY = 'o^q-xrj_)1z^dw^cxi-@4qe!aw+^$8g%har9k$c$p$3*!@ks#k'
...
WSGI_APPLICATION = 'use_rbac.wsgi.application'
