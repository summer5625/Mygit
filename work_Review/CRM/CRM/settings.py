...
SECRET_KEY = 'gw$pt#(l5ih8#ymn4kb4qd2i!$k+ji_$@pu!-2&66ss@$mh(k4'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'proe/../templates')]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
RBAC_USER_MODEL_CLASS = 'proe.models.UserInfo'
